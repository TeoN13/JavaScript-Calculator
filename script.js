const Controls = (props) => {
  return (
    <div id="controls">
      <button onClick={props.updateDisplay} id="clear" class="btn btn-danger">
        AC
      </button>
      <button onClick={props.updateDisplay} id="divide" class="btn btn-light">
        /
      </button>
      <button onClick={props.updateDisplay} id="multiply" class="btn btn-light">
        x
      </button>
      <button onClick={props.updateDisplay} id="seven" class="btn btn-dark">
        7
      </button>
      <button onClick={props.updateDisplay} id="eight" class="btn btn-dark">
        8
      </button>
      <button onClick={props.updateDisplay} id="nine" class="btn btn-dark">
        9
      </button>
      <button onClick={props.updateDisplay} id="subtract" class="btn btn-light">
        -
      </button>
      <button onClick={props.updateDisplay} id="four" class="btn btn-dark">
        4
      </button>
      <button onClick={props.updateDisplay} id="five" class="btn btn-dark">
        5
      </button>
      <button onClick={props.updateDisplay} id="six" class="btn btn-dark">
        6
      </button>
      <button onClick={props.updateDisplay} id="add" class="btn btn-light">
        +
      </button>
      <button onClick={props.updateDisplay} id="one" class="btn btn-dark">
        1
      </button>
      <button onClick={props.updateDisplay} id="two" class="btn btn-dark">
        2
      </button>
      <button onClick={props.updateDisplay} id="three" class="btn btn-dark">
        3
      </button>
      <button onClick={props.updateDisplay} id="equals" class="btn btn-primary">
        =
      </button>
      <button onClick={props.updateDisplay} id="zero" class="btn btn-dark">
        0
      </button>
      <button onClick={props.updateDisplay} id="decimal" class="btn btn-dark">
        .
      </button>
    </div>
  );
...
class Calculator extends React.Component {
  ...
  render() {
    return (
      <div>
        <div id="display-div">
          <div id="ecuation">{this.state.ecuation}</div>
          <div id="display">{this.state.input}</div>
        </div>
        <Controls updateDisplay={this.updateDisplay} />
      </div>
    );
  }
}
